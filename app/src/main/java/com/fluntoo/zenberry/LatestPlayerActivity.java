...
public class LatestPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latest_player);
...
//
        ...
        speedBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(LatestPlayerActivity.this);
...
//        });
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fullscreen) {
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(LatestPlayerActivity.this, R.drawable.ic_baseline_screen_rotation_24));
