...
//    @Expose
//    private List<Object> movieLinkedMovie = null;
...
//    }
//
//    public List<Object> getMovieLinkedMovie() {
//        return movieLinkedMovie;
//    }
//
//    public void setMovieLinkedMovie(List<Object> movieLinkedMovie) {
...
//                ", movieURL='" + movieURL + '\'' +
//                ", movieAffiliateUrl=" + movieAffiliateUrl +
//                ", movieEmbedContent=" + movieEmbedContent +
//                ", movieReleaseDate='" + movieReleaseDate + '\'' +
//                ", movieDateadded=" + movieDateadded +
//                ", movieTimeDuration='" + movieTimeDuration + '\'' +
//                ", movieCensorRating='" + movieCensorRating + '\'' +
//                ", movieIMDBID='" + movieIMDBID + '\'' +
//                ", movieTMDBID='" + movieTMDBID + '\'' +
//                ", movieCatlogVisibility='" + movieCatlogVisibility + '\'' +
//                ", movieId='" + movieId + '\'' +
//                ", userId=" + userId +
//                ", views=" + views +
//                ", movieFeatured=" + movieFeatured +
//                ", movieLinkedMovie=" + movieLinkedMovie +
//                ", movieLinkedVideo=" + movieLinkedVideo +
//                ", movieCast=" + movieCast +
//                ", movieGenres=" + movieGenres +
//                ", movieCrew=" + movieCrew +
//                ", movieAtributes=" + movieAtributes +
//                ", movieSources=" + movieSources +
//                ", movieRestrication='" + movieRestrication + '\'' +
//                ", movieDisplayForLoggedUser=" + movieDisplayForLoggedUser +
//                ", movieEnableCustomMessage=" + movieEnableCustomMessage +
//                ", movieMessageForLoggedOutUser='" + movieMessageForLoggedOutUser + '\'' +
//                ", movieMessageForLoggedOutUserMedia='" + movieMessageForLoggedOutUserMedia + '\'' +
//                ", movieMessageForLoggedInNonMembera='" + movieMessageForLoggedInNonMembera + '\'' +
//                ", movieMessageForLoggedInNonMemberaMedia='" + movieMessageForLoggedInNonMemberaMedia + '\'' +
//                ", movieDescription='" + movieDescription + '\'' +
//                ", movieDescriptionMedia='" + movieDescriptionMedia + '\'' +
//                ", movieVisibility='" + movieVisibility + '\'' +
//                ", movieProtectedPassword='" + movieProtectedPassword + '\'' +
//                ", moviePublish='" + moviePublish + '\'' +
//                ", moviePendingReview=" + moviePendingReview +
//                ", movieSlug='" + movieSlug + '\'' +
