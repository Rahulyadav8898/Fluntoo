...
public class Player extends AppCompatActivity {
    public static final int REPEAT_MODE_ONE = 123;
...
//        videoView = findViewById(R.id.videoView);
        ...
        recyclerViewcomment = findViewById(R.id.recyclerview_comment1);
...
//                    Toast.makeText(getApplicationContext(), "You are not logged in !!", Toast.LENGTH_SHORT).show();
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(Player.this)
//set icon
...
//        });
        ...
        fullscreenButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (fullscreen) {
                    fullscreenButton.setImageDrawable(ContextCompat.getDrawable(Player.this, R.drawable.full_screen));
...
//              });
    ...
    private void postwatchlater() {
        ...
        String Url = "https://api.fluntoo.com/video/" + user + "/watchlater/" + vid;
        Log.d("watch", Url);
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void bell() {
        ...
        String Url = "https://api.fluntoo.com/video/" + user + "/subscribe/" + cvid;
        Log.d("view", Url);
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void getViews() {
        String Url = "https://api.fluntoo.com/video/views/" + vid;
        Log.d("urlview", Url);
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void getcomment() {
        ...
        String Url = "https://api.fluntoo.com/video/videocomments/" + vid;
...
//        String Url="https://www.api.playflixx.com/videocomments/Jl3T1tTSWOzhEg";
    ...
    private void postdislike() {
        long dislikess = 1;
        String Url = "https://api.fluntoo.com/video/videodislikes/" + vid;
        Log.d("lik", Url);
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void postlike() {
        ...
        String Url = "https://api.fluntoo.com/video/videolikes/" + vid;
        ...
        sendcom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isLogin) {
                    ...
                    String Url = "https://api.fluntoo.com/video/" + user + "/videocomments/" + vid;
                    Log.d("comments", Url);
...
//        String Url="https://www.api.playflixx.com/recommendedvideo/"+user;
        ...
        String Url = "https://api.fluntoo.com/video/videoplay/" + vidcat;
        Log.i("end", Url);
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://www.api.playflixx.com/")
                .addConverterFactory(GsonConverterFactory.create())
